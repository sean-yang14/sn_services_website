...
const tiers = [
  {
    ...
    description: 'Getting the very best service without adding to your debt',
  ...
  },  
  {
    ...
    description: 'Ensure you are getting the very best contract possible.',
    features: [
      'Unlimited reviews by our recruiting experts',
      'Compare contract terms to actual signed contracts by your peers',
      'For $250, 1x review by our legal experts',
      'For $500, 3x reviews and redlines by our legal experts',
    ],
  },
]
