  ...
  return (
    <section className="isolate overflow-hidden bg-white px-6 lg:px-8">
      ...
      <div className="relative mx-auto max-w-2xl py-24 sm:py-32 lg:max-w-4xl">
        <h2 className="text-center text-2xl font-bold tracking-tight text-gray-900 sm:text-4xl mb-12">Your one-stop partner to help you get a dental job that fits your lifestyle</h2>
        ...
        <figure className="grid grid-cols-1 items-center gap-x-6 gap-y-8 lg:gap-x-10">
          <div className="relative col-span-2 lg:col-start-1 lg:row-start-2">
            ...
            <blockquote className="text-xl font-semibold leading-8 text-gray-900 sm:text-2xl sm:leading-9">
              <p>
                Testimonials. Commodo amet fugiat excepteur sunt qui ea elit cupidatat ullamco consectetur ipsum elit consequat. Elit
          ...
          <figcaption className="text-base lg:col-start-1 lg:row-start-3">
            ...
            <div className="mt-1 text-gray-500">DMD NYU '18</div>
          </figcaption>
        </figure>
      </div>
    </section>
